...
-- 8. Keep happy new year 2015!
    ...
    <title>Wireless 12V Single Colour LED Strip Dimmer</title></head>\
    <body><h3>Wireless Controller 12V Single Colour LED Strip Dimmer</h3>\
	<form action="" method="post">\
    <input type="submit" name="pwmi" value="OFF">\
    <input type="submit" name="pwmi" value="10">\
    <input type="submit" name="pwmi" value="20">\
    <input type="submit" name="pwmi" value="30">\
    ...
    <input type="submit" name="pwmi" value="80">\
    <input type="submit" name="pwmi" value="90">\
    <input type="submit" name="pwmi" value="ON">\
